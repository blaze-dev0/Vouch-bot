...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    if(!member) {
      let membed = client.functions.failEmbed("Failed", `<:error:1054779253662691328> Unable to find the user.`)
...
- The user is blacklisted from the bot.`)
   ...
   await member.send({ embeds: [embedTwo] });
    ...
    let embedThree = new MessageEmbed()
      ...
      .setFooter({ text: "Frisk"})
      .setColor("2F3136");

    let ch = "1111640519223816213";//paste here
